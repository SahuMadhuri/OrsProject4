...
public class MyProfileCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("firstName"))) {
			System.out.println("MyProfilectl firstName" + request.getParameter("firstName"));
		...
		if (DataValidator.isNull(request.getParameter("lastName"))) {
			System.out.println("MyProfilectl firstName" + request.getParameter("lastName"));
		...
		if (DataValidator.isNull(request.getParameter("gender"))) {
			System.out.println("MyProfilectl gender" + request.getParameter("gender"));
			request.setAttribute("gender", PropertyReader.getValue("error.require", "Gender"));
			pass = false;
		}
		if (DataValidator.isNull(request.getParameter("mobileNo"))) {
			System.out.println("MyProfilectl mobileNo" + request.getParameter("mobileNo"));
			request.setAttribute("mobileNo", PropertyReader.getValue("error.require", "MobileNo"));
			pass = false;
		} else if (!DataValidator.isPhoneLength(request.getParameter("mobileNo"))) {
			System.out.println("MyProfilectl phonelength " + request.getParameter("mobileNo"));
			request.setAttribute("mobileNo", "Mobile No must have 10 digits");
			pass = false;
		} else if (!DataValidator.isPhoneNo(request.getParameter("mobileNo"))) {
			System.out.println("MyProfilectl isPhoneNo" + request.getParameter("mobileNo"));
			request.setAttribute("mobileNo", "Invalid Mobile No");
			pass = false;
		}

		if (DataValidator.isNull(request.getParameter("dob"))) {
			System.out.println("MyProfilectl isNull" + request.getParameter("dob"));
...
System.out.print(("MyprofileCTL"+DataUtility.getLong(request.getParameter("id"))));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Myprofile doget id"+id);
		String op = DataUtility.getString(request.getParameter("operation"));
System.out.println("Myprofile doget op2"+op);
		// get model
