...
public class CollegeModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		System.out.println("CollegeModel nextPK Started");
		...
		System.out.println("CollegeModel nextPK end");
		return pk + 1;
	}
	...
	public long add(CollegeBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("CollegeModel add Started");
		Connection conn = null;
		int pk = 0;
		...
		System.out.println("CollegeModel add end");
		return pk;
	}
	...
	public void delete(CollegeBean bean) throws ApplicationException {
		...
		System.out.println("CollegeModel delete Started");
		Connection conn = null;
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false); // Begin transaction
		...
		log.debug("Model delete Started");
		System.out.println("CollegeModel delete end");
	}
	...
	public CollegeBean findByName(String name) throws ApplicationException {
		...
		System.out.println("CollegeModel findByName Started");
		...
		System.out.println("CollegeModel FindByName End");
		return bean;
	}
	...
	public CollegeBean findByPK(long pk) throws ApplicationException {
		...
		System.out.println("CollegeModel findByPK Started");
		...
		System.out.println("CollegeModel findByPK End");
		return bean;
	}
	...
	public void update(CollegeBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("CollegeModel update Started");
		Connection conn = null;
		...
		System.out.println("CollegeModel update End");
	}
	...
	public List<CollegeBean> search(CollegeBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("CollegeModel Search end");
		return list;
	}
	...
	public List<CollegeBean> list(int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("CollegeModel list Started");
		ArrayList<CollegeBean> list = new ArrayList<CollegeBean>();
		...
		System.out.println("CollegeModel list End");
		return list;
