...
public abstract class BaseModel implements Comparable<BaseModel> {
	...
	public void updateCreatedInfo() throws ApplicationException {
		...
		System.out.println("BaseModel updateCreatedInfo Started..." + createdBy);
		...
		System.out.println("BaseModel update End");
	}
	...
	public void updateModifiedInfo() throws Exception {
		...
		System.out.println("Model updateModifiedInfo Started");
		Connection conn = null;
		...
		log.debug("Model update End");
		System.out.println("Model updateModifiedInfo End");
	}
