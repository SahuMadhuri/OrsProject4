...
public class MarksheetModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		System.out.println("MarkSheetModel next pk sterted ");
		Connection conn = null;
		int pk = 0;
		try {
			conn = JDBCDataSource.getConnection();
			System.out.println("Connection Succesfully Establish conn" +conn);
		...
		System.out.println("MarkSheetModel next pk end ");
		return pk + 1;
	}
	...
	public long add(MarksheetBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("MarkSheetModel add sterted ");
		Connection conn = null;
	...
	public void delete(MarksheetBean bean) throws ApplicationException {
		...
		System.out.println("MarkSheetModel delete sterted ");
		Connection conn = null;
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false); // Begin transaction
		...
		System.out.println("MarksheetModel delete End");
	}
	...
	public MarksheetBean findByRollNo(String rollNo) throws ApplicationException {
		...
		System.out.println("MarkSheetModel findByRollNo sterted ");
		...
		System.out.println("MarksheetModel findByRollNo End");
		return bean;
	}
	...
	public MarksheetBean findByPK(long pk) throws ApplicationException {
		...
		System.out.println("MarkSheetModel finfBypk sterted ");
	...
	public void update(MarksheetBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("MarkSheetModel update sterted ");
		Connection conn = null;
	...
	public List<MarksheetBean> search(MarksheetBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("MarkSheetModel search sterted ");
		System.out.println("MarkSheetModel search roll "+bean.getRollNo());
		System.out.println("MarkSheetModel search name "+bean.getName());
	...
	public List<MarksheetBean> list(int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("MarkSheetModel list sterted ");
		ArrayList<MarksheetBean> list = new ArrayList<MarksheetBean>();
	...
	public List<MarksheetBean> getMeritList(int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("MarkSheetModel MeritList sterted ");
		ArrayList<MarksheetBean> list = new ArrayList<MarksheetBean>();
		...
		System.out.println("MarkSheetModel MeritList End ");
		return list;
	}
