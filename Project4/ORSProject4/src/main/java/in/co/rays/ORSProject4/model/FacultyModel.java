...
public class FacultyModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		System.out.println("FacultyModel next pk sterted ");
		...
		System.out.println("FacultyModel next pk end ");
		return pk + 1;
	}
	...
	public long add(FacultyBean bean) throws Exception {
		...
		System.out.println("FacultyModel add sterted ");
		Connection conn = null;
		int pk = 0;
		...
		System.out.println("FacultyModel add end ");
		return pk;
	}
	...
	public void delete(FacultyBean bean) throws ApplicationException {
		...
		System.out.println("FacultyModel delete sterted ");
		Connection conn = null;
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false); // Begin transaction
		...
		log.debug("Model delete Started");
		System.out.println("FacultyModel delete end ");
	}
	...
	public FacultyBean findByEmail(String email) throws ApplicationException {
		...
		System.out.println("FacultyModel FindByLogin sterted ");
		...
		System.out.println("FacultyModel FindByEmail sterted ");
		return bean;
	}
	...
	public FacultyBean findByPK(long pk) throws ApplicationException {
		...
		System.out.println("FacultyModel findByPk sterted ");
		...
		System.out.println("FacultyModel FindByPk end ");
		return bean;
	}
	...
	public void update(FacultyBean bean) throws Exception {
		...
		System.out.println("FacultyModel update started ");
		Connection conn = null;
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE ST_FACULTY SET COLLEGE_ID=?,SUBJECT_ID=?,COURSE_ID=?,F_NAME=?,L_NAME=?,GENDER=?,DOB=?,EMAIL=?"
		...
		System.out.println("FacultyModel update end ");
	}
	...
	public List<FacultyBean> search(FacultyBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("FacultyModel search sterted ");
		...
		System.out.println("FacultyModel search end ");
		return list;
	}
	...
	public List<FacultyBean> list(int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("FacultyModel list sterted ");
		ArrayList<FacultyBean> list = new ArrayList<FacultyBean>();
		StringBuffer sql = new StringBuffer("select * from ST_FACULTY ORDER BY F_NAME");
		// if page size is greater than zero then apply pagination
		if (pageSize > 0) {
			// Calculate start record index
			pageNo = (pageNo - 1) * pageSize;
		...
		System.out.println("FacultyModel list End ");
		return list;
