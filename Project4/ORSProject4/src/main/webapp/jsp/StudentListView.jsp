...
<%@page import="in.co.rays.ORSProject4.ctl.StudentListCtl"%>
<%@page import="in.co.rays.ORSProject4.util.ServletUtility"%>
<%@page import="in.co.rays.ORSProject4.bean.StudentBean"%>
...
<script type="text/javascript" src="<%=ORSView.APP_CONTEXT%>/js/CheckBox.js">
