<%@page import="in.co.rays.ORSProject4.ctl.RoleListCtl"%>
...
<body>
	...
	<jsp:useBean id="bean" class="in.co.rays.ORSProject4.bean.RoleBean"
...
System.out.println("Roleview pageNo "+pageNo);
