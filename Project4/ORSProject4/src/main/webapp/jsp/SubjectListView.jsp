...
<%@page import="in.co.rays.ORSProject4.ctl.SubjectListCtl"%>
<%@page import="in.co.rays.ORSProject4.util.ServletUtility"%>
<%@page import="in.co.rays.ORSProject4.bean.SubjectBean"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="in.co.rays.ORSProject4.model.SubjectModel"%>
<%@page import="in.co.rays.ORSProject4.model.StudentModel"%>
...
<body>
	...
	<div align="center">
		...
		<jsp:useBean id="bean" class="in.co.rays.ORSProject4.bean.SubjectBean"
