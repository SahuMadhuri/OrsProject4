...
<%@page import="in.co.rays.ORSProject4.ctl.CourseCtl"%>
...
<body>
	<form action="<%=ORSView.COURSE_CTL%>" method="post">
		...
		<jsp:useBean id="bean" class="in.co.rays.ORSProject4.bean.CourseBean"
			...
			<table>
				<tr>
					...
					<td align="center"><input type="text" name="name"
						placeholder="Enter Course Name" style="width: 177px;
