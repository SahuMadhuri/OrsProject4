...
<%@page import="in.co.rays.ORSProject4.ctl.CollegeListCtl"%>
<%@page import="in.co.rays.ORSProject4.util.ServletUtility"%>
<%@page import="in.co.rays.ORSProject4.bean.CollegeBean"%>
...
<body>
	...
	<div align="center">
		<jsp:useBean id="bean" class="in.co.rays.ORSProject4.bean.CollegeBean"
		...
		<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="POST">
			...
			<table border="1" style="width: 100%; border: groove;">
				...
				<tr>
					...
					<a href="CollegeCtl?id=<%=bean.getId()%>">Edit</a></td>
				</tr>
				<%
					}
				%>
