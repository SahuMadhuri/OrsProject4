...
<%@page import="in.co.rays.ORSProject4.bean.FacultyBean"%>
<%@page import="java.util.List"%>
<%@page import="java.util.HashMap"%>
<%@page import="in.co.rays.ORSProject4.util.HTMLUtility"%>
<%@page import="in.co.rays.ORSProject4.ctl.FacultyCtl"%>
...
<body ng-app="720" ng-controller="TestController as ctrl">
	<form action="<%=ORSView.FACULTY_CTL%>" method="post">
		...
		<jsp:useBean id="bean" class="in.co.rays.ORSProject4.bean.FacultyBean"
