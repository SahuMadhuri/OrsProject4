...
<%@page import="in.co.rays.ORSProject4.ctl.GetMarksheetCtl"%>
...
<body>
	...
	<jsp:useBean id="bean" class="in.co.rays.ORSProject4.bean.MarksheetBean"
	...
	<div align="center">
		...
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<%
				...
				System.out.println("GetMarkSheetView Physics"+physics);
				System.out.println("GetMarkSheetView chemistry "+chemistry);
				System.out.println("GetMarkSheetView Maths"+maths);
				int total = physics + chemistry + maths;
				System.out.println("GetMarkSheetView total "+total);
				float percentage = (float) total / 3;
				System.out.println("GetMarkSheetView Percentage "+percentage);
