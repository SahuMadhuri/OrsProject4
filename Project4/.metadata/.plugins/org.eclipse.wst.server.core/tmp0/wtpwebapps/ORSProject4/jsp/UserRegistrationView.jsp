<%@page import="in.co.rays.ORSProject4.ctl.UserRegistrationCtl"%>
...
<body ng-app="720" ng-controller="TestController as ctrl">
	<form action="<%=ORSView.USER_REGISTRATION_CTL%>" method="post">
		...
		<jsp:useBean id="bean" class="in.co.rays.ORSProject4.bean.UserBean"
		...
		<div align="center">
			...
			<table>
				...
				<tr>
					...
					<td>
						<div class="input-group"><span class="input-group-addon"> <span
							...
							<div data-datepicker date-format="MM/dd/yyyy" date-typer="true" date-max-limit="{{maxDate}}" date-min-limit="{{minDate1}}">
								<input type="text" name="dob" placeholder="Select Date of Birth" readonly="readonly" value="<%=DataUtility.getDateString(bean.getDob())%>">
							</div>
						</div>
					</td>
				...
				<tr>
					...
					<td><input type="text" name="mobileNo" maxlength="10" placeholder="Enter Mobile No." value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
