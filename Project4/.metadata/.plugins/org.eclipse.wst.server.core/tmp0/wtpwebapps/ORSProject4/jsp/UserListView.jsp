...
<%@page import="in.co.rays.ORSProject4.model.RoleModel"%>
<%@page import="java.util.Date"%>
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="in.co.rays.ORSProject4.util.DataUtility"%>
<%@page import="in.co.rays.ORSProject4.bean.BaseBean"%>
<%@page import="in.co.rays.ORSProject4.ctl.UserListCtl"%>
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>First Name :</b></label> <input
						...
						name="login" placeholder="Enter Email ID" value="<%=ServletUtility.getParameter("login", request)%>">&emsp;
